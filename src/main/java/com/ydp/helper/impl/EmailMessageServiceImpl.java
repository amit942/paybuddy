...
public class EmailMessageServiceImpl extends AbstractMessageHelperService {
    ...
    @Override
    public boolean sendMessage(String baseUrl, String receipient, String txnid, String link, String amount) {
    ...
    public static void main(String[] args) {
        ...
        boolean s = obj.sendMessage("localhost:8080", "priyanka.dudani@snapdeal.com", "newtxnid", "14bf9dde2d1vdmGsXhCYS", "123");
